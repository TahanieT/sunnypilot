...
from openpilot.selfdrive.ui.sunnypilot.onroad.auto_pass_indicator import AutoPassIndicator
...
class HudRendererSP(HudRenderer):
  def __init__(self):
    ...
    self.auto_pass_indicator = AutoPassIndicator()
  ...
  def _update_state(self) -> None:
    ...
    self.auto_pass_indicator.update()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    self.auto_pass_indicator.render(rect)
